...
TString OptionToFieldFlagName(TFieldOption option)
{
    ...
    return TString(EWrapperFieldFlag_Enum_Name(std::visit(TVisitor(), option)));
}
...
TString OptionToMessageFlagName(TMessageOption option)
{
    ...
    return TString(EWrapperMessageFlag_Enum_Name(std::visit(TVisitor(), option)));
}
...
TString OptionToOneofFlagName(TOneofOption option)
{
    ...
    return TString(EWrapperOneofFlag_Enum_Name(std::visit(TVisitor(), option)));
}
